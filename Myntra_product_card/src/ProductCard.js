...
const ProductCard = () => {
  ...
  const [isAttributeOpen, updateAttributeOpenState] = React.useState(false);  
  return (
    <div className="main-card-container">
      ...
      <div className="actions-container">
        ...
        <div
          className="item-action-div1"
          onClick={() => updateAttributeOpenState(!isAttributeOpen)}
        >
          <a style={{ display: "block" }}>
            {!isAttributeOpen ? "ADD TO WISHLIST" : "DONE"}
          </a>
        </div>
      </div>
    </div>
